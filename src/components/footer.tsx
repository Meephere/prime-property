...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#111111] border-t border-zinc-900 text-zinc-400 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-zinc-400">
              <li>
                <Link href="/" className="hover:text-[#C9A961] transition-colors duration-200 flex items-center group">
                  <span>Beranda</span>
                </Link>
              </li>
              <li>
                <Link href="/tentang-kami" className="hover:text-[#C9A961] transition-colors duration-200 flex items-center group">
                  <span>Tentang Kami</span>
                </Link>
              </li>
              <li>
                <Link href="/kontak" className="hover:text-[#C9A961] transition-colors duration-200 flex items-center group">
            ...
            <ul className="space-y-3 text-sm text-zinc-400">
              <li className="flex items-center space-x-3">
                ...
                <a 
                  ...
                  className="hover:text-[#C9A961] transition-colors duration-200 flex items-center"
                >
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@primeproperty.com" className="hover:text-[#C9A961] transition-colors duration-200">
                  info@primeproperty.com
                </a>
              </li>
              <li className="text-xs text-zinc-500 mt-2 pt-2 border-t border-zinc-800">
        ...
        {/* Copyright */}
        <div className="border-t border-zinc-800 mt-12 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-zinc-500">
